...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h52c05e51dff61b52: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__Fn___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h22dfeffe94aaf4b5: (a: number, b: number, c: number) => void;
